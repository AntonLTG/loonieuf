    ...
    <div class="content-wrapper">
      <div class="middle-content-wrapper">
        ...
        <div class="mini-content-wrapper">
          <h2 class="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Företg</h2>
          <FooterLinkGroup>
            <FooterLink liClass="mb-4" href="/">Om oss</FooterLink>
            <FooterLink liClass="mb-4" href="/">Betalningsmetoder</FooterLink>
          </FooterLinkGroup>
        </div>
        <div class="mini-content-wrapper">
          
          <h2 class="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Följ oss</h2>
          <FooterLinkGroup>
